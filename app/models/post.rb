...
# (attributes{})This is so that we can instantiate an empty Post, 
...
#the same behaviour as title.present? && body.present? && author.present?
#present? method, which is a method that Rails provides. return false if call on nil and empty string
	def valid?
